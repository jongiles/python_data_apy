# 4.50:  Quantifying a group.  First create a pattern that is
# 1 or more digits with comma separator (i.e. matching on 0,,
# 00, 000,) and group the number with parentheses; quantify
# the group to say that there is zero or more of these,
# followed by one or more digits, a period and 1-2 digits.
